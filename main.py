...
PAYMENT_CHANNEL = "@Addclicker_bot" #add payment channel here including the '@' sign
OWNER_ID = 6148397160 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@Addclicker_bot "] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
...
Per_Refer = 0.001 #add per refer bonus here
